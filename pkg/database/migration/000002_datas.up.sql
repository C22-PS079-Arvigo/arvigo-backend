...
(
    ...
    is_subscription_active int default 0 not null,
...
CREATE TABLE user_personalities (
    ...
    ext_result double null,
    est_result double null,
    agr_result double null,
    csn_result double null,
    opn_result double null,
